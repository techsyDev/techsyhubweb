    ...
    <Box className="w-full min-h-[90vh] h-fit px-7 py-2 bg-white">
      ...
      <Box className="flex items-center justify-between">
        <Box className="flex ">
          ...
          <Typography
            className="text-[#758CA3] text-sm capitalize poppins"
            sx={{ marginLeft: "10px" }}
          >
            Total {title} 48
          </Typography>
        ...
        <Link
          href={{ pathname: "/management", query: { route: "add customer" } }}
        >
          <Button
            variant="contained"
            className="button-bg bg-none py-2.5 px-4 text-xs rounded-lg shadow-none"
          >
      ...
      <Box className="flex items-center justify-between">
        ...
        <Box className="flex items-center justify-evenly mt-3">
          <div>
            ...
            >
              {rowsPerPage} out of {customers.length} Records
            </Button>
            <Menu
              id="basic-menu"
              anchorEl={anchorEl}
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow className="button-bg rounded-lg">
              <TableCell className="text-white poppins rounded-l-xl ps-7 w-32 text-xs border-b-0">
                Name
              </TableCell>
                      ...
                      <Tooltip title="See Profile">
                        <IconButton size="small">
                          <Link
                            href={{
                              pathname: "/management",
                              query: { route: "user", name: row.name },
                            }}
                          >
